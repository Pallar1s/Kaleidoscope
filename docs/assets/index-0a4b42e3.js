 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(C,N){var L=C.length;C.push(N);e:for(;0<L;){var X=L-1>>>1,b=C[X];if(0<o(b,N))C[X]=N,C[L]=b,L=X;else break e}}function n(C){return C.length===0?null:C[0]}function r(C){if(C.length===0)return null;var N=C[0],L=C.pop();if(L!==N){C[0]=L;e:for(var X=0,b=C.length,Ke=b>>>1;X<Ke;){var $e=2*(X+1)-1,Nt=C[$e],he=$e+1,Rt=C[he];if(0>o(Nt,L))he<b&&0>o(Rt,Nt)?(C[X]=Rt,C[he]=L,X=he):(C[X]=Nt,C[$e]=L,X=$e);else if(he<b&&0>o(Rt,L))C[X]=Rt,C[he]=L,X=he;else break e}}return N}function o(C,N){var L=C.sortIndex-N.sortIndex;return L!==0?L:C.id-N.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var i=Date,u=i.now();e.unstable_now=function(){return i.now()-u}}var a=[],c=[],m=1,p=null,v=3,S=!1,h=!1,_=!1,P=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,s=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function d(C){for(var N=n(c);N!==null;){if(N.callback===null)r(c);else if(N.startTime<=C)r(c),N.sortIndex=N.expirationTime,t(a,N);else break;N=n(c)}}function g(C){if(_=!1,d(C),!h)if(n(a)!==null)h=!0,st(y);else{var N=n(c);N!==null&&be(g,N.startTime-C)}}function y(C,N){h=!1,_&&(_=!1,f(w),w=-1),S=!0;var L=v;try{for(d(N),p=n(a);p!==null&&(!(p.expirationTime>N)||C&&!fe());){var X=p.callback;if(typeof X=="function"){p.callback=null,v=p.priorityLevel;var b=X(p.expirationTime<=N);N=e.unstable_now(),typeof b=="function"?p.callback=b:p===n(a)&&r(a),d(N)}else r(a);p=n(a)}if(p!==null)var Ke=!0;else{var $e=n(c);$e!==null&&be(g,$e.startTime-N),Ke=!1}return Ke}finally{p=null,v=L,S=!1}}var x=!1,k=null,w=-1,I=5,R=-1;function fe(){return!(e.unstable_now()-R<I)}function Ve(){if(k!==null){var C=e.unstable_now();R=C;var N=!0;try{N=k(!0,C)}finally{N?We():(x=!1,k=null)}}else x=!1}var We;if(typeof s=="function")We=function(){s(Ve)};else if(typeof MessageChannel<"u"){var Cn=new MessageChannel,wn=Cn.port2;Cn.port1.onmessage=Ve,We=function(){wn.postMessage(null)}}else We=function(){P(Ve,0)};function st(C){k=C,x||(x=!0,We())}function be(C,N){w=P(function(){C(e.unstable_now())},N)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(C){C.callback=null},e.unstable_continueExecution=function(){h||S||(h=!0,st(y))},e.unstable_forceFrameRate=function(C){0>C||125<C?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):I=0<C?Math.floor(1e3/C):5},e.unstable_getCurrentPriorityLevel=function(){return v},e.unstable_getFirstCallbackNode=function(){return n(a)},e.unstable_next=function(C){switch(v){case 1:case 2:case 3:var N=3;break;default:N=v}var L=v;v=N;try{return C()}finally{v=L}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(C,N){switch(C){case 1:case 2:case 3:case 4:case 5:break;default:C=3}var L=v;v=C;try{return N()}finally{v=L}},e.unstable_scheduleCallback=function(C,N,L){var X=e.unstable_now();switch(typeof L=="object"&&L!==null?(L=L.delay,L=typeof L=="number"&&0<L?X+L:X):L=X,C){case 1:var b=-1;break;case 2:b=250;break;case 5:b=1073741823;break;case 4:b=1e4;break;default:b=5e3}return b=L+b,C={id:m++,callback:N,priorityLevel:C,startTime:L,expirationTime:b,sortIndex:-1},L>X?(C.sortIndex=L,t(c,C),n(a)===null&&C===n(c)&&(_?(f(w),w=-1):_=!0,be(g,L-X))):(C.sortIndex=b,t(a,C),h||S||(h=!0,st(y))),C},e.unstable_shouldYield=fe,e.unstable_wrapCallback=function(C){var N=v;return function(){var L=v;v=N;try{return C.apply(this,arguments)}finally{v=L}}}})(ka);Ea.exports=ka;var tf=Ea.exports;/**
 * @license React
...
`,Nd=Object.freeze(Object.defineProperty({__proto__:null,edgesFragmentShader:Pd},Symbol.toStringTag,{value:"Module"})),Rd=`
  precision highp float;
...
`,Ld=Object.freeze(Object.defineProperty({__proto__:null,fire2FragmentShader:Rd},Symbol.toStringTag,{value:"Module"})),Dd=`
  precision highp float;
...
`,Kd=Object.freeze(Object.defineProperty({__proto__:null,channelSources:Gd,nightSeaFragmentShader:bd},Symbol.toStringTag,{value:"Module"})),Zd={iChannel0:"trail"},qd=`
  precision highp float;
...
`,ep=Object.freeze(Object.defineProperty({__proto__:null,channelSources:Zd,rainFragmentShader:qd},Symbol.toStringTag,{value:"Module"})),tp=`
  precision highp float;
